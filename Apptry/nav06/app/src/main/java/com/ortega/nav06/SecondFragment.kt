...
import com.ortega.nav06.databinding.ActivityMainBinding
import com.ortega.nav06.databinding.FragmentSecondBinding
...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.continueEditText.setOnClickListener {
